...
4. Pick the cheapest capable model from the current repository policy. Use Terra, Luna, or local Qwen for broad
   mechanical coverage and stronger models for hard judgment. Name every model in a comparison before starting.
